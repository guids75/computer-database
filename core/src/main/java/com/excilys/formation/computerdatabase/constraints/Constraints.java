package com.excilys.formation.computerdatabase.constraints;
...
/**
 * Contains all the constraints necessary for the requests.
 */
public final class Constraints {
    ...
    private Constraints(final ConstraintsBuilder builder) {
